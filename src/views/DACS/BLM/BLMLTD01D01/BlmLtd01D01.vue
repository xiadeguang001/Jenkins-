...
*   
*   ページ： 積込集計ダウンロード
*   説明： 積込集計ダウンロード ダウンロード画面
*
-->
<template>
    <div>
        <h1 class="p-pageTitle">{{$t('app.BlmWhi01D01.10018')}}</h1>
        <p class="p-pageSubText">{{$t('app.BlmWhi01D01.10019')}}</p>
        <a-card :bordered="false">
                    ...
                    <a-form :form="form" class="standard-form">
                        ...
                        <a-form-item :label="$t('app.AlmAli01D01.10018')"
                            ...
                            :wrapperCol="wrapperCol">
                                ...
                                <a-select :disabled="isDisabled" style="width: 160px" @click="handleButtonClick">
                         ...
                         <a-form-item :label="$t('app.AlmAli01D01.10016')"
                            :labelCol="labelCol"
                            :wrapperCol="wrapperCol">
                                <a-date-picker v-model="nyukoymdStart" :disabled="isDisabled"  :placeholder="$t('app.AlmAli01D01.10036')" format="YYYY-MM-DD"  @Change="sendDayChange" style="width: 160px" ></a-date-picker> ~
                                <a-date-picker v-model="nyukoymdEnd" :disabled="isDisabled"  :placeholder="$t('app.AlmAli01D01.10036')" format="YYYY-MM-DD"  @Change="sendDayChange" style="width: 160px" ></a-date-picker>
                        </a-form-item>
                        <div>
                            &nbsp;&nbsp;
                        </div>
            ...
            <div style="z-index:999 " class="drawer-bootom-button">                          
                <a-button @click="handleCancel" style="margin-left: 8px">{{this.$t('app.OthSdc01D01.10004')}}</a-button>
                <a-button @click="submit" type="primary" :loading="confirmLoading"  >{{this.$t('app.BlmWhi01D01.10020')}}</a-button>       
            </div>
        ...
        computed: {
            validatorRules:function() {
                return {
                    ...
                    deliveryDestination:{ rules: [{ required: true, message: this.$t('app.message.msg0001',{'0':this.$t('app.BlmWhi01D01.10010') })}]}
                }
            }
        },
        methods: {
