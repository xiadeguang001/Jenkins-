...
<template>
    <div>
        <h1 class="p-pageTitle">{{$t('app.BlmWhi01D01.10012')}}</h1>
        <p class="p-pageSubText">{{$t('app.BlmWhi01D01.10013')}}</p>
            ...
            <div :style="{padding: '10px 16px',background: '#fff',}">
                <a-spin :spinning="confirmLoading">
                    ...
                    <a-form :form="form" class="standard-form">
                        ...
                        <a-form-item :label="$t('app.BlmWhi01D01.10014')"
                            :labelCol="labelCol"
                        ...
                        <a-form-item :label="$t('app.BlmWhi01D01.10015')"
                            :labelCol="labelCol"
                            :wrapperCol="wrapperCol">
