...
<template>
    <div>
        <h1 class="p-pageTitle">{{$t('app.BlmWhi01D01.10008')}}</h1>
        <p class="p-pageSubText">{{$t('app.BlmWhi01D01.10009')}}</p>
            ...
            <div :style="{padding: '10px 16px',background: '#fff',}">
                <a-spin :spinning="confirmLoading">
                    ...
                    <a-form  :form="form" class="standard-form">
                        ...
                        <a-form-item :label="$t('app.BlmWhi01D01.10011')"
                            :labelCol="labelCol"
                        ...
                        <a-form-item :label="$t('app.BlmWhi01D01.10010')"
                            :labelCol="labelCol"
                            :wrapperCol="wrapperCol">
                                <a-input v-if="selectValue==0" v-decorator="['deliveryDestination', validatorRules.deliveryDestination]" :disabled="isDisabled"  ></a-input>
                                <a-input v-if="selectValue == 1" :disabled="isDisabled" v-model="deliveryDestination" ></a-input>
                        </a-form-item>
                        <div>
                            &nbsp;&nbsp;
                        </div>
