        ...
        <div :style="{width: '100%',padding: '10px 16px',background: '#fff',}">
            <a-spin :spinning="confirmLoading">
                <a-form :form="form" class="standard-form">
                    ...
                    <a-form-item :label="$t('app.AlmAli01D01.10021')"
                        :labelCol="labelCol"
                        :wrapperCol="wrapperCol">
                        <a-time-picker :placeholder="$t('app.AlmAli01D01.10019')" format="h:mm" style="width: 150px" @change="changeArrivalsTime" /> 以降
                    </a-form-item>

                    <a-form-item :label="$t('app.AlmAli01D01.10022')"
                        :labelCol="labelCol"
                        :wrapperCol="wrapperCol">
                        <a-switch default-checked @change="isInquiredNumber" />
                    </a-form-item>

                    <a-form-item :label="$t('app.AlmAli01D01.10023')"
                        :labelCol="labelCol"
                        :wrapperCol="wrapperCol">
                        <a-switch default-checked @change="isShowNumber" />
                    </a-form-item>
                </a-form>
            </a-spin>
        </div>
...
<script>
    ...
    export default {
        ...
        return {
            drawerWidth: 600,
            title:this.$t('app.common.search'), // 航空便种检索model
            blCode:"",
