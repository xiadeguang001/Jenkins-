    ...
    <div class="table-page-search-wrapper" style="margin-bottom: 15px">
        <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24" >
                ...
                <a-col :md="12" :sm="8">
                    <a-form-item :label="$t('app.MstDrt01D01.10011')"
                    :labelCol="labelCol"
                    :wrapperCol="wrapperCol">  
...
<script>
    ...
    export default {
        name: "MstDrt01D02", // ＢＬキャリア選択搜索view
        ...
        data() {
            return {
                title: this.$t('app.MstDrt01D01.10012'),
                visible: false,
                visibleCheck: true,
                selectCode:"",
                selectDescription:"",
                ...
                columns:[
                    ...
                    {
                        // ＢＬキャリアコード
                        title: this.$t('app.MstDrt01D01.10013'),
                        align: "center",
                    ...
                    {
                        // ＢＬキャリア名
                        title: this.$t('app.MstDrt01D01.10011'),
                        align: "left",
                        dataIndex: 'blcarriernm'
                    },
                ],
                url: {
                    list: "/dacs/dairitenMaintenance/blcarrierSearch",
                },
            }
        },
        created() {
        ...
        methods: {
            ...
            add(blcarriercd,blcarriernm) {
                this.selectCode = blcarriercd;
                this.selectDescription = blcarriernm;
                this.edit({});
            },
            ...
            selectRow(record){
                this.$emit("ok",record.blcarriercd,record.blcarriernm);
                this.close();
            }
        }
    }
