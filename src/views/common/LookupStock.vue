      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline"  @keyup.enter.native="searchQuery">
          <a-row :gutter="24">
             <!-- 客户编号 -->
            <a-col :md="8" :sm="24">
              <a-form-item label="产品" :labelCol="labelCol" :wapperCol="wrapperCol">
                <a-input v-model="productName" disabled="disabled"></a-input>
              </a-form-item>
            </a-col>
            <!-- 客户名称 -->
            <a-col :md="8" :sm="24">
              <a-form-item label="采购单号" :labelCol="labelCol" :wapperCol="wrapperCol">
                <a-input v-model="queryParam.purchaseNo"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
...
<script>
  ...
  export default {
    props : {proId : Number, productName : String},
    name: "LookupStock",
    components: {
      JInput,
      JEllipsis,
