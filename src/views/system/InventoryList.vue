<template>
  <a-card :bordered="false">
    ...
    <Inventory-Log-modal ref="logModalForm"></Inventory-Log-modal>
  </a-card>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/sys/inventoryList/list',
        delete: '/sys/inventoryList/delete',
        deleteBatch: '/sys/inventoryList/deleteBatch',
      },
    }
  },
  computed: {
