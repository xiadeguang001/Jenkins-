<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="10">
            ...
            <a-form-item :label="$t('app.label.Job.denpyoShurui')">
              <j-dict-select-tag v-model="queryParam.katsushimaShurui" dictCode="katsushimaShurui" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="10">
    ...
    <!-- 表单区域 -->
    <KatsushimaShushihokoku-modal ref="modalForm" @ok="modalFormOk"></KatsushimaShushihokoku-modal>
    <KatsushimaShushihokoku-Log-modal ref="logModalForm"></KatsushimaShushihokoku-Log-modal>
    <KatsushimaShushihokoku-Out-modal ref="outModalForm"></KatsushimaShushihokoku-Out-modal>
  </a-card>
</template>

<script>
import KatsushimaShushihokokuModal from './modules/KatsushimaShushihokokuModal'
import KatsushimaShushihokokuLogModal from './modules/KatsushimaShushihokokuLogModal'
import KatsushimaShushihokokuOutModal from './modules/KatsushimaShushihokokuOutModal'
...
export default {
  ...
  components: {
    KatsushimaShushihokokuModal,
    KatsushimaShushihokokuLogModal,
    KatsushimaShushihokokuOutModal,
    JEllipsis,
  },
  data() {
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: 'left',
          width: 100,
          dataIndex: 'katsushimaShuruiDict',
        },
        {
      ...
      url: {
        list: '/sys/katsushimaShushihokoku/list',
        delete: '/sys/katsushimaShushihokoku/delete',
        deleteBatch: '/sys/katsushimaShushihokoku/deleteBatch',
      },
    }
  },
  computed: {
