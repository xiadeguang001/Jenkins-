      ...
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-date-picker
            style="width: 195px"
            format="YYYY-MM-DD"
            v-decorator="['outputDate',{initialValue:moment(getCurrentData(), 'YYYY-MM-DD'),rules: [{ required: true, message: $t('app.message.msg0001',{'0': $t('app.label.Job.outputDate')}) }]}]"
...
<!-- 
         <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          :label="$t('app.label.Job.seikyushoShurui')">
          <j-dict-select-tag  dictCode="seikyushoShurui" :triggerChange="true"  @change="onSelectChange"
              v-decorator="['seikyushoShurui', {rules: [{ required: true, message: $t('app.message.msg0001',{'0': $t('app.label.Job.seikyushoShurui')}) }]}]" />
        </a-form-item> -->
      ...
      handleSubmit () {
        ...
        this.form.validateFields((err, values) => { 
          if (!err) {
            ...
            if (this.queryParam.createTime_begin != null && ( this.queryParam.seikyushoShurui ==6)) {
             
                formData.createTime_begin = this.queryParam.createTime_begin;
            }
            if (this.queryParam.createTime_end != null && ( this.queryParam.seikyushoShurui ==6)) {
            ...
            if (formData.outputDate != null ) { 
                formData.outputDate = formData.outputDate.format('YYYY-MM-DD');
            }
