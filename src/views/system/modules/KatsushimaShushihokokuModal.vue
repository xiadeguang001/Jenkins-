      ...
      <a-form :form="form">
        ...
        <a-form-item
         ...
         <a-form-item
          ...
          <j-dict-select-tag  dictCode="katsushimaShurui" :triggerChange="true"  @change="onSelectChange"
              v-decorator="['katsushimaShurui', {rules: [{ required: true, message: $t('app.message.msg0001',{'0': $t('app.label.Job.denpyoShurui')}) }]}]" />
        </a-form-item>
<!-- 
...
<script>
  ...
  export default {
    name: "KatsushimaShushihokokuModal",
    components: {
      JCron,
      JUpload
    },
    data () {
      return {
        ...
        url: {
          add: "/sys/katsushimaShushihokoku/add"
        }
      }
    },
    computed:{
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'katsushimaShurui','originalData','remark'));
        });
        ...
        this.form.validateFields((err, values) => { 
          if (!err) {
            ...
            httpAction(httpurl,formData,method).then((res)=>{
              ...
              this.isAble = false; 
              this.queryParam.katsushimaShurui = 0;
      ...
      onSelectChange(value) {
        ...
        // } else {
          ...
          this.queryParam.createTimeRange=[]
        //}
        this.queryParam.katsushimaShurui = value;
      },      
      moment,
      getCurrentData(){
