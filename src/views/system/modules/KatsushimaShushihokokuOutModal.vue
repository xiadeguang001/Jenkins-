...
<script>
  ...
  import {quartzStatus,getJobClasses,ouputPost} from '@/api/api'
  ...
  export default {
    name: "KatsushimaShushihokokuOutModal",
    components: {
      JCron,
      JUpload
    },
    ...
    methods: {
      ...
      handleSubmit () {
        ...
        if (!err) {
          ...
          ouputPost(formData).then((response) => {
            ...
            if (formData.denpyoShurui == '1') {
              fileName = 'output_99.9_' + fileName
            } else if (formData.denpyoShurui == '2') {
              fileName = 'output_FP1_' + fileName
            } else if (formData.denpyoShurui == '3') {
              fileName = 'output_iO_' + fileName
            } else if (formData.denpyoShurui == '4') {
              fileName = 'output_SDスマホ_' + fileName
            } else if (formData.denpyoShurui == '5') {
              fileName = 'output_スマプリ_' + fileName
            } else if (formData.denpyoShurui == '6') {
              fileName = 'output_決済端末【G7】_' + fileName
            } else if (formData.denpyoShurui == '7') {
