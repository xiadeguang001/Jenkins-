    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :label="$t('app.label.ruleName')">
          <a-input v-decorator="['ruleName', validatorRules.ruleName]"/>
        </a-form-item>
        <a-form-item
          v-show="showRuleColumn"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          :label="$t('app.label.ruleColumn')">
          <a-input v-decorator="['ruleColumn', validatorRules.ruleColumn]"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          :label="$t('app.label.ruleConditional')">
          <j-dict-select-tag @change="handleChangeRuleCondition" v-decorator="['ruleConditions', validatorRules.ruleConditions]" :triggerChange="true" dictCode="rule_conditions"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          :label="$t('app.label.ruleValue')">
          <a-input v-decorator="['ruleValue', validatorRules.ruleValue]"/>
        </a-form-item>
        ...
        <a-form-item
          ...
          <a-radio-group buttonStyle="solid" v-decorator="['status',{initialValue:'1'}]">
            <a-radio-button value="1" v-html="$t('app.label.valid')"></a-radio-button>
            <a-radio-button value="0" v-html="$t('app.label.invalid')"></a-radio-button>
          </a-radio-group>
        </a-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        permissionId: '',
        validatorRules: {
          ruleConditions: {rules: [{required: true, message: getMsgInfo(this,'choice','rule')}]},
          ruleName: {rules: [{required: true, message: getMsgInfo(this,'choice','ruleName')}]},
          ruleValue: {rules: [{required: true, message: getMsgInfo(this,'choice','ruleValue') }]},
          ruleColumn: {rules: []}
        },
        url: {
