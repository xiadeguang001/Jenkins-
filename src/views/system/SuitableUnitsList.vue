<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <!-- <a-col :md="6" :sm="10">
            <a-form-item :label="$t('app.label.Job.seikyushoShurui')">
              <j-dict-select-tag v-model="queryParam.seikyushoShurui" dictCode="seikyushoShurui"  :triggerChange="true"  @change="onSelectChangeSer"/>
            </a-form-item>
          </a-col> -->
          <a-col :md="6" :sm="10">
    ...
    <!-- 表单区域 -->
    <SuitableUnits-modal ref="modalForm" @ok="modalFormOk"></SuitableUnits-modal>
    <SuitableUnits-Log-modal ref="logModalForm"></SuitableUnits-Log-modal>
  </a-card>
</template>

<script>
import SuitableUnitsModal from './modules/SuitableUnitsModal'
import SuitableUnitsLogModal from './modules/SuitableUnitsLogModal'
import { getAction, postAction } from '@/api/manage'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'
import JEllipsis from '@/components/jeecg/JEllipsis'
import { axios } from '@/utils/request'
import { download, output } from '@/api/api'
import { getMsgInfo } from '@/utils/util'

export default {
  name: 'SuitableUnitsList',
  mixins: [JeecgListMixin],
  components: {
    SuitableUnitsModal,
    SuitableUnitsLogModal,
    JEllipsis,
  },
  data() {
    return {
      ...
      url: {
        list: '/sys/suitableUnitsList/list',
        delete: '/sys/suitableUnitsList/delete',
        deleteBatch: '/sys/suitableUnitsList/deleteBatch',
      },
    }
  },
  computed: {
  ...
  methods: {
    ...
    //     console.log("aaa")
    //      if(value==1 && this.columns[3].dataIndex == "shuryoJikan"){
    //         this.columns.splice(3,1);
    //      } else if(this.columns[3].dataIndex != "shuryoJikan"){
