<template>
  <a-drawer
    :title="$t('app.label.dataPermissionRules')"
    :width="drawerWidth"
    @close="onClose"
    :visible="visible"
    ...
    <div
      ...
      <div class="table-page-search-wrapper">
        <a-form @keyup.enter.native="searchQuery">
          <a-row :gutter="12">
            <a-col :md="8" :sm="8">
              <a-form-item :label="$t('app.label.ruleName')" :labelCol="{span: 8}" :wrapperCol="{span: 14, offset: 1}">
                <a-input  v-model="queryParam.ruleName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="8">
              <a-form-item :label="$t('app.label.ruleValue')" :labelCol="{span: 8}" :wrapperCol="{span: 14, offset: 1}">
                <a-input v-model="queryParam.ruleValue"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="7" :sm="8">
              <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
                <a-button type="primary" @click="searchQuery" icon="search" v-html="$t('app.common.search')"></a-button>
                <a-button type="primary" @click="searchReset" icon="reload" style="margin-left: 8px" v-html="$t('app.common.reload')"></a-button>
              </span>
            </a-col>
          </a-row>
          <a-row>
            <a-col :md="24" :sm="24">
              <a-button style="margin-bottom: 10px" @click="addPermissionRule" type="primary" icon="plus" v-html="$t('app.common.addition')"></a-button>
            </a-col>
          </a-row>
        </a-form>
        ...
        <a-table
          ...
          :loading="loading"
          :rowClassName="getRowClassname,InterlaceDiscoloration">
  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
    {
      title: this.$t('app.label.ruleName'),
      dataIndex: 'ruleName',
      key: 'ruleName'
    },
    {
      title: this.$t('app.label.ruleColumn'),
      dataIndex: 'ruleColumn',
      key: 'ruleColumn'
    },
    {
      title: this.$t('app.label.ruleValue'),
      dataIndex: 'ruleValue',
      key: 'ruleValue'
    },
    {
